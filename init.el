...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (js2-mode clj-refactor leuven-theme smartparens helm-projectile projectile helm-ag helm yaml-mode web-mode tide meghanada markdown-mode magit json-mode groovy-mode elpy dockerfile-mode ac-cider cider clojure-snippets ac-helm)))
 '(savehist-mode t)
